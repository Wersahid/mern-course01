...
export const loader = async ({ request }) => {
    ...
    // console.log(params);
     try {
          ...
          return {data, searchValues: {...params}}; // $$ searchValues ... auto search section $$$
...
const AllJobs = () => {
     const {data, searchValues} = useLoaderData(); // incorporamos el loader, determinamos que en la pagina AllJobs aparecera el name del usuario logueado
     //console.log(data);
