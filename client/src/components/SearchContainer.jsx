// front-end  for the pagination 1
...
const SearchContainer = () => {
  const { searchValues} = useAllJobsContext(); // $$ auto search section $$$
  const { search ,jobStatus, jobType, sort} = searchValues;   // $$ auto search section $$$
  const submit = useSubmit();  // $$$ auto search $$$$$
